				...
				<div class="row bg-title">
					<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
						<c:if test="${not empty listRoles}">
							<h4 class="page-title">Edit quyền</h4>
						</c:if>
					...
					<div class="col-md-8 col-xs-12">
						<div class="white-box">
							...
							<form class="form-horizontal form-material"
								action="${not empty role ? 'role-update?id=' += role.id : 'role-add'}"
								method="post">

								<div class="form-group">
									<label class="col-md-12">Tên quyền</label>
									<div class="col-md-12">
										<input value="${not empty role ? role.name : ''}" type="text"
											name="roleName" placeholder="Tên quyền"
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<input value="${not empty role ? role.description : ''}"
								...
								<div class="form-group">
									<div class="col-sm-12">
										<button type="submit" class="btn btn-success">${not empty role ? 'Update Role' : 'Add Role'}
										</button>
