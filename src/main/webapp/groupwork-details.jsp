					...
					<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
						<div class="white-box">
							<div class="col-in row">
								...
								<div class="col-md-6 col-sm-6 col-xs-6">
									<h3 class="counter text-right m-t-15 text-danger">${perNotStart}%</h3>
								</div>
								<div class="col-md-12 col-sm-12 col-xs-12">
									<div class="progress">
										<div class="progress-bar progress-bar-megna"
											role="progressbar" aria-valuenow="40" aria-valuemin="0"
											aria-valuemax="100" style="width: ${perNotStart}%"></div>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
						<div class="white-box">
							<div class="col-in row">
								...
								<div class="col-md-6 col-sm-6 col-xs-6">
									<h3 class="counter text-right m-t-15 text-megna">${perInProgress}%</h3>
								</div>
								<div class="col-md-12 col-sm-12 col-xs-12">
									<div class="progress">
										<div class="progress-bar progress-bar-megna"
											role="progressbar" aria-valuenow="40" aria-valuemin="0"
											aria-valuemax="100" style="width: ${perInProgress}%"></div>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
						<div class="white-box">
							<div class="col-in row">
								...
								<div class="col-md-6 col-sm-6 col-xs-6">
									<h3 class="counter text-right m-t-15 text-primary">${perDone}%</h3>
								</div>
								<div class="col-md-12 col-sm-12 col-xs-12">
									<div class="progress">
										<div class="progress-bar progress-bar-primary"
											role="progressbar" aria-valuenow="40" aria-valuemin="0"
											aria-valuemax="100" style="width: ${perDone}%"></div>
									</div>
								</div>
							</div>
						</div>
					...
					<c:forEach var="user" items="${userList}">
						<div class="col-xs-12 m-t-20">
							<a href="#" class="group-title"> <img width="30"
								src="plugins/images/users/varun.jpg" class="img-circle" /> <span>${user.fullName}</span>
							</a>
						</div>

						<!-- Cột 1: Chưa thực hiện -->
						<div class="col-md-4">
							<div class="white-box">
								<h3 class="box-title">Chưa thực hiện</h3>
								<div class="message-center">
									<c:forEach var="task" items="${taskList}">
										<c:if test="${task.user_id == user.id && task.status_id == 1}">
											<a href="#">
												<div class="mail-contnet">
													<h5>${task.name}</h5>
													<span class="mail-desc">${task.jobName}</span> <span
														class="time">Bắt đầu: ${task.start_date}</span> <span
						...
						<div class="col-md-4">
							<div class="white-box">
								...
								<div class="message-center">
									<c:forEach var="task" items="${taskList}">
										<c:if test="${task.user_id == user.id && task.status_id == 2}">
											<a href="#">
												<div class="mail-contnet">
													<h5>${task.name}</h5>
													<span class="mail-desc">${task.jobName}</span> <span
						...
						<div class="col-md-4">
							<div class="white-box">
								...
								<div class="message-center">
									<c:forEach var="task" items="${taskList}">
										<c:if test="${task.user_id == user.id && task.status_id == 3}">
											<a href="#">
												<div class="mail-contnet">
													<h5>${task.name}</h5>
													<span class="mail-desc">${task.jobName}</span> <span
