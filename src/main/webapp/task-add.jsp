				...
				<div class="row bg-title">
					<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
						<c:if test="${not empty task}">
							<h4 class="page-title">Edit cong viec</h4>
						</c:if>
						<c:if test="${empty listRoles}">
							<h4 class="page-title">Thêm mới cong viec</h4>
						</c:if>
					</div>
				</div>
				<!-- /.row -->
				...
				<div class="row">
					...
					<div class="col-md-8 col-xs-12">
						<div class="white-box">
							...
							action="${not empty task ? 'task-update?id=' += task.id : 'task-add'}"
							method="post">
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<input
										value="${not empty task ? task.name : ''}" type="text" 
										name="name" type="text" placeholder="Tên công việc"
								...
								<div class="form-group">
									<label class="col-md-12">Trạng thai </label>
									<div class="col-md-12">
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<input
										value="${not empty task ? task.start_date : ''}" type="text" 
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<input 
										value="${not empty task ? task.end_date : ''}"
										name="end_date" type="text" placeholder="dd/MM/yyyy"
											class="form-control form-control-line">
									</div>
								</div>
								<div class="form-group">
