			...
			<div class="sidebar-nav navbar-collapse slimscrollsidebar">
				<ul class="nav" id="side-menu">
                    <li style="padding: 10px 0 0;">
                        <a href="indexs" class="waves-effect"><i class="fa fa-clock-o fa-fw"
					...
					<div class="col-md-8 col-xs-12">
						<div class="white-box">
							<form class="form-horizontal form-material"
								action="${not empty job ? 'groupwork-update?id=' += job.id : 'groupwork-add'}"
								method="post">
								<div class="form-group">
									<label class="col-md-12">Tên dự án</label>
									<div class="col-md-12">
										<input value="${not empty job ? job.name : ''}" name="name"
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<input value="${not empty job ? job.start_date : ''}"
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<input value="${not empty job ? job.end_date : ''}"
