				...
				<div class="row bg-title">
					<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
						<c:if test="${not empty user}">
							<h4 class="page-title">Edit thanh vien</h4>
						</c:if>
						<c:if test="${empty user}">
							<h4 class="page-title">Thêm mới thanh vien</h4>
						</c:if>
					</div>
				</div>
				<!-- /.row -->
				...
				<div class="row">
					...
					<div class="col-md-8 col-xs-12">
						<div class="white-box">
							...
							action="${not empty user ? 'user-update?id=' += user.id : 'user-add'}"
							method="post">
								<div class="form-group">
									<label class="col-md-12">Full Name</label>
									<div class="col-md-12">
										<input 
										value="${not empty user ? user.fullName : ''}"
