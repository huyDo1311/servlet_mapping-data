						...
						<div class="white-box">
							...
							class="form-horizontal form-material">
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<input value="${job.name}" type="text" readonly 
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<input value="${task.name}" type="text" readonly value="Thiết kế database"
											class="form-control form-control-line">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-12">
										<input value="${task.start_date}" type="text" readonly value="05-07/2020"
											class="form-control form-control-line">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-12">
										<input value="${task.end_date}" type="text" readonly value="17-07/2020"
											class="form-control form-control-line">
									</div>
								</div>
								<div class="form-group">
